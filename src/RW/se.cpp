/*
  ...
  This is a partial implementation of the idea of:
  PARTI: A Multi-interval Theory Solver for Symbolic Execution (https://ieeexplore.ieee.org/abstract/document/9000034)
*/
